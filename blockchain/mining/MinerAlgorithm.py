...
class MinerAlgorithm(Thread):
    ...
    # def sendNotificationOfStoringBlockInLedger(self, ledgerHandler, blockStoringInLedgerObject):
    #     """
    #     Send notification of storing a block mined in ledger
    #
    #     :param ledgerHandler:
    #     :param blockStoringInLedgerObject:
    #     :return:
    #     """
    #
    #     # We suppose we are real winner (real winner is miner that can store his block)
    #     realWinner = True
    #
    #     # Get confirmation of real winning from each hosts
    #     for host in self.miningStatus.minerConfiguration.getKnownHosts():
    #
    #         # Get confirmation
    #         realWinner = realWinner and BlockStoringInLedgerHandlerClient \
    #             .sendBlockStoringInLedgerNotification(time=blockStoringInLedgerObject.time,
    #                                                   seed=blockStoringInLedgerObject.seed,
    #                                                   transactions_list=blockStoringInLedgerObject.transactionList,
    #                                                   block_hash=blockStoringInLedgerObject.blockHash,
    #                                                   lottery_number=blockStoringInLedgerObject.lotteryNumber,
    #                                                   miner_address=blockStoringInLedgerObject.minerAddress,
    #                                                   previous_block_hash=blockStoringInLedgerObject.previousBlockHash,
    #                                                   host=host)
    #
    #     # If i am the real winner
    #     if realWinner:
    #         # Add in blockchain
    #         ledgerHandler.insertBlockInLedger(
    #             BlockMiningObject(time=blockStoringInLedgerObject.time,
    #                               seed=blockStoringInLedgerObject.seed,
    #                               transactions_list=blockStoringInLedgerObject.transactionList,
    #                               block_hash=blockStoringInLedgerObject.blockHash,
    #                               lottery_number=blockStoringInLedgerObject.lotteryNumber,
    ...
    #                               )
    #         )
    #         # self.miningStatus.blockStoringInLedgerNotifications.append(blockStoringInLedgerObject)
    #         # self.miningStatus.thereIsAtLeastAnyBlockToStoreInLedger = True
